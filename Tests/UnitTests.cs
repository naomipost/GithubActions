...
{
    [TestMethod]
    public void Subtract_Valid_Post()
    {
    ...
    [TestMethod]
    public void Subtract_Invalid_Post()
    {
    ...
    [TestMethod]
    public void Subtract_Null_Post()
    {
...
{
    [TestMethod]
    public void Multiply_Valid_Post()
    {
    ...
    [TestMethod]
    public void Multiply_Invalid_Post()
    {
    ...
    [TestMethod]
    public void Multiply_Null_Post()
    {
...
{
    [TestMethod]
    public void Divide_Valid_Post()
    {
        Assert.AreEqual(0.5, Program.Divide("1", "2"));
        Assert.AreEqual(1.5, Program.Divide("3", "2"));
        Assert.AreEqual(.57, Program.Divide("5", "7"));
    }

    [TestMethod]
    public void Divide_Invalid_Post()
    {
...
public class Power
{
    ...
    [TestMethod]
    public void Power_Invalid_Post()
    {
